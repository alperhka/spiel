...
."SpielGetController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,SpielGetController,svg]
----
include::SpielGetController.plantuml[]
----
...
."SpielWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,SpielGetController,svg]
----
include::SpielWriteController.plantuml[]
----
...
.SpielQueryResolver für Lesezugriffe an der GraphQL-Schnittstelle
[plantuml,SpielQueryResolver,svg]
----
include::SpielQueryResolver.plantuml[]
----

Donec sollicitudin molestie malesuada. Praesent sapien massa, convallis a
pellentesque nec, egestas non nisi.

.SpielMutationResolver für Schreibzugriffe an der GraphQL-Schnittstelle
[plantuml,SpielMutationResolver,svg]
----
include::SpielMutationResolver.plantuml[]
----
...
."SpielReadService" von der Geschäftslogik
[plantuml,SpielReadService,svg]
----
include::SpielReadService.plantuml[]
----

Pellentesque in ipsum id orci porta dapibus. Donec rutrum congue leo eget
malesuada.

."SpielWriteService" von der Geschäftslogik
[plantuml,SpielWriteService,svg]
----
include::SpielWriteService.plantuml[]
----
