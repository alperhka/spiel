...
In der Datei `app.yml` im Verzeichnis `.extras\compose\spiel` werden bei der
...
Jetzt kann man die Docker-Container mit den Backend-Server und dem Spiel-Server
starten:
