...
class SpielRequests(HttpUser):
    """Lasttest für HTTP-Requests fuer Server Spiel."""
    ...
    def get_id(self) -> None:
        """GET-Requests mit Pfadparameter: Spiel-ID."""
        id_list: Final = [1, 20, 30, 40, 50, 60]
        for spiel_id in id_list:
            self.client.get(f"/rest/{spiel_id}")

    @task(200)
    def get_name(self) -> None:
        """GET-Requests mit Query-Parameter: Teilstring des Spielnamens."""
        name_list = ["a", "l", "t", "i", "p"]
    ...
    def get_barcode(self) -> None:
        """GET-Requests mit Query-Parameter: BARCODE-Nummer."""
        barcode_list: Final = [
            "978-3-897-22583-1",
            "978-3-827-31552-6",
            "978-0-201-63361-0",
        ...
        for barcode in barcode_list:
            self.client.get("/rest", params={"barcode": barcode})
