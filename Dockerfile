...
# Aufruf:   docker build --tag juergenzimmermann/spiel:2025.4.1-bookworm .
#               ggf. --progress=plain
#               ggf. --no-cache
#           Get-Content Dockerfile | docker run --rm --interactive hadolint/hadolint:2.12.1-beta-debian
#               Linux:   cat Dockerfile | docker run --rm --interactive hadolint/hadolint:2.12.1-beta-debian
#           docker save juergenzimmermann/spiel:2025.4.1-bookworm > spiel.tar
#           docker network ls
...
LABEL org.opencontainers.image.title="spiel" \
  org.opencontainers.image.description="Appserver spiel mit Basis-Image Debian Bookworm" \
