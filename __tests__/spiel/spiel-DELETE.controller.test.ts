...
describe('DELETE /rest/spiele', () => {
    ...
    test('Vorhandenes Spiel loeschen', async () => {
        // given
        const url = `/rest/${id}`;
    ...
    test('Spiel loeschen, aber ohne Token', async () => {
        // given
        const url = `/rest/${id}`;
    ...
    test('Spiel loeschen, aber mit falschem Token', async () => {
        // given
        const url = `/rest/${id}`;
        const token = 'FALSCH';
        const headers: Record<string, string> = {
    ...
    test('Vorhandenes Spiel als "user" loeschen', async () => {
        // given
        const url = `/rest/60`;
