...
describe('GET /rest', () => {
    ...
    test('Spiele mit einem Teil-Name suchen', async () => {
        // given
    ...
    test('Spiele zu einem nicht vorhandenen Teil-Name suchen', async () => {
        // given
    ...
    test('Spiele mit Mindest-"rating" suchen', async () => {
        // given
    ...
    test('Spiele mit max. Preis suchen', async () => {
        // given
        ...
        // Jedes Spiel hat einen Name mit dem Teilstring 'a'
        data.content
            .map((spiel) => Decimal(spiel.preis))
            .forEach((preis) =>
                expect(preis.lessThanOrEqualTo(Decimal(preisMax))).toBeTruthy(),
            );
    });

    test('Mind. 1 Spiel mit vorhandenem Schlagwort', async () => {
        // given
    ...
    test('Keine Spiele zu einem nicht vorhandenen Schlagwort', async () => {
        // given
    ...
    test('Keine Spiele zu einer nicht-vorhandenen Property', async () => {
        // given
