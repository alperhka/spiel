...
const options = {
    ...
    base_dir: '.extras/doc/projekthandspiel',
    to_dir: 'html',
    mkdirs: true,
};
adoc.convertFile(
    join('.extras', 'doc', 'projekthandspiel', 'projekthandspiel.adoc'),
    options,
);
