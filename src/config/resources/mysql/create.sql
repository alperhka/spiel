...
) TABLESPACE spielspace ROW_FORMAT=COMPACT;
ALTER TABLE spiel AUTO_INCREMENT=1000;

CREATE TABLE IF NOT EXISTS name (
    id          INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
    name       VARCHAR(40) NOT NULL,
    untertitel  VARCHAR(40),
    spiel_id     INT UNIQUE NOT NULL references spiel(id)
) TABLESPACE spielspace ROW_FORMAT=COMPACT;
ALTER TABLE name AUTO_INCREMENT=1000;

CREATE TABLE IF NOT EXISTS bild (
    id              INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
    beschriftung    VARCHAR(32) NOT NULL,
    content_type    VARCHAR(16) NOT NULL,
    spiel_id         INT NOT NULL references spiel(id),

    INDEX bild_spiel_id_idx(spiel_id)
) TABLESPACE spielspace ROW_FORMAT=COMPACT;
ALTER TABLE bild AUTO_INCREMENT=1000;
...
ALTER TABLE spiel_file AUTO_INCREMENT=1000;
