...
/**
 * Exception-Klasse für eine bereits existierende BARCODE-Nummer.
 */
export class BarcodeExistsException extends HttpException {
    readonly barcode: string;

    constructor(barcode: string) {
        super(
            `Die BARCODE-Nummer ${barcode} existiert bereits.`,
