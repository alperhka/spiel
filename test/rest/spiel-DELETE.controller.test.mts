...
describe('DELETE /rest', () => {
    ...
    test.concurrent('Vorhandenes Spiel loeschen', async () => {
        // given
        const url = `/${id}`;
    ...
    test.concurrent('Spiel loeschen, aber ohne Token', async () => {
        // given
        const url = `/${id}`;
    ...
    test.concurrent('Spiel loeschen, aber mit falschem Token', async () => {
        // given
        const url = `/${id}`;
        const token = 'FALSCH';
        const headers: Record<string, string> = {
    ...
    test.concurrent('Vorhandenes Spiel als "user" loeschen', async () => {
        // given
        const url = `/60`;
        const headers: Record<string, string> = {
