...
describe('GET /rest/:id', () => {
    ...
    test.concurrent('Spiel zu vorhandener ID', async () => {
        ...
        // when
        const { status, headers, data }: AxiosResponse<Spiel> =
    ...
    test.concurrent('Kein Spiel zu nicht-vorhandener ID', async () => {
        // given
    ...
    test.concurrent('Kein Spiel zu falscher ID', async () => {
        // given
        const url = `/${idFalsch}`;
    ...
    test.concurrent('Spiel zu vorhandener ID mit ETag', async () => {
        // given
